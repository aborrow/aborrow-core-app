...
.controller('OffersController', function($firebaseObject, $firebaseArray, FirebaseUrl, $scope, $filter, $http, profile) {
    // var config = {
    ...
    //TODO get current app and pass vars to loanAmount, etc
